...
MACRO(dxm_config_find_module MODULE)
	...
	IF(DXM_CMAKE_PLATFORM_WIN32)
		...
		dxm_find_module(${MODULE} PACKAGE external COMPONENTS websockets libzlib libwebp libiconv freetype250 libbox2d libpng libjpeg libtiff glew32 glfw3 libchipmunk libSpine)	
		...
		dxm_find_module(${MODULE} PACKAGE chipmunk HEADERS glfw3/glfw3.h)	
		dxm_find_module(${MODULE} PACKAGE curl HEADERS glfw3/glfw3.h)	
		dxm_find_module(${MODULE} PACKAGE freetype2 HEADERS glfw3/glfw3.h)	
		dxm_find_module(${MODULE} PACKAGE glfw3 HEADERS glfw3/glfw3.h)			
		dxm_find_module(${MODULE} PACKAGE gles HEADERS gles/gles.h)		
		dxm_find_add_libraries(${MODULE} ws2_32 wsock32 winmm)
